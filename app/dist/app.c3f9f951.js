...
function _fetchData() {
  _fetchData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(endpoint) {
...
function _fetchBreweries() {
  _fetchBreweries = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(endpoint) {
...
function _getGeo() {
  _getGeo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(address) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("https://maps.googleapis.com/maps/api/geocode/json?address=".concat(address, "&key=").concat(undefined));
